...
Serializers _$serializers = (new Serializers().toBuilder()
      ...
      ..add(InitialResponse.serializer)
      ..add(LoginRequest.serializer)
      ..add(LoginUserResponse.serializer)
      ..add(MeResponse.serializer)
      ..add(PrefectureResponse.serializer)
      ..add(ReceiveMessageResponse.serializer)
      ..add(SendLikeRequest.serializer)
      ..add(SendLikeResponse.serializer)
