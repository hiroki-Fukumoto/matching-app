...
import 'package:openapi/src/api/health_check_api.dart';
import 'package:openapi/src/api/initial_api.dart';
import 'package:openapi/src/api/messages_api.dart';
import 'package:openapi/src/api/send_like_api.dart';
...
class Openapi {
  ...
  /// Get InitialApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  InitialApi getInitialApi() {
    return InitialApi(dio, serializers);
  }
  ...
  /// Get SendLikeApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  SendLikeApi getSendLikeApi() {
    return SendLikeApi(dio, serializers);
  }
