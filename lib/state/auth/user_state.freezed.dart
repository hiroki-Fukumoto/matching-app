...
abstract class $UserStateCopyWith<$Res> {
  ...
  $Res call({LoginUserModel loginUser});
}
...
class _$_UserState implements _UserState {
  const _$_UserState({required this.loginUser});
  ...
  @override
  String toString() {
    return 'UserState(loginUser: $loginUser)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(loginUser));
...
abstract class _UserState implements UserState {
  const factory _UserState({required final LoginUserModel loginUser}) =
      _$_UserState;
